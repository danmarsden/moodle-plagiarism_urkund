...
$string['storedocuments'] = 'Add submissions to Urkund database';
$string['storedocuments_help'] = 'If set to yes, submissions will be added to the Urkund database for future comparison with other submissions, if set to No the document will be deleted from Urkund after anaylsis is complete.';
...
$string['urkund_api_help'] = 'This is the address of the URKUND API, default: https://secure.urkund.com';
...
$string['errorcode_409'] = 'Your receiver address has been deleted and needs to be restored, please contact Urkund to restore this account';
