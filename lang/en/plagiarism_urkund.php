...
$string['fetchmahara'] = 'Fetch Mahara portfolios for checking';
$string['file'] = 'File';
...
$string['maharawshtmllitesecret'] = 'Mahara HTML Lite OAuth secret';
$string['maharawshtmllitesecret_help'] = 'The HTML Lite OAuth secret from the partner Mahara sute.';
$string['maharawshtmllitetoken'] = 'Mahara HTML Lite access token';
$string['maharawshtmllitetoken_help'] = 'The HTML Lite access token from the partner Mahara sute.';
$string['maharawsurl'] = 'Mahara site URL';
$string['maharawsurl_help'] = 'The URL of the partner Mahara sute.  (Must be the Mahara site URL defined in the <i>Mahara submissions</i> plugin.)';
