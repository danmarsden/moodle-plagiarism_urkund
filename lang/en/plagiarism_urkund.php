...
$string['errorcode_4'] = 'Error code 4 – Document missed deadline (will only happen if the course feature within the Ouriginal web inbox is used to set a deadline)';
