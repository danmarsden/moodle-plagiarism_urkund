...
$string['urkund_userpref'] = 'Use last saved reciever';
$string['urkund_userprefdesc'] = 'If enabled, the last reciever address entered by the user will be saved as the default address to use when the user creates a new assignment. If not enabled the site default will always be used.';
