...
function xmldb_plagiarism_urkund_upgrade($oldversion) {
    ...
    if ($oldversion < 2017020803) {
        ...
        // Urkund savepoint reached.
        upgrade_plugin_savepoint(true, 2017020803, 'plagiarism', 'urkund');
    }

    if ($oldversion < 2017020808) {
        ...
        // Urkund savepoint reached.
        upgrade_plugin_savepoint(true, 2017020808, 'plagiarism', 'urkund');
    }
