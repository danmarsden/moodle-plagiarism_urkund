...
function xmldb_plagiarism_urkund_upgrade($oldversion) {
    ...
    if ($oldversion < 2015122905) {
        ...
        upgrade_plugin_savepoint(true, 2015122905, 'plagiarism', 'urkund');
    }

    if ($oldversion < 2015122908) {
        ...
        // Urkund savepoint reached.
        upgrade_plugin_savepoint(true, 2015122908, 'plagiarism', 'urkund');
    }

    if ($oldversion < 2015122909) {
        ...
        // Urkund savepoint reached.
        upgrade_plugin_savepoint(true, 2015122909, 'plagiarism', 'urkund');
    }
